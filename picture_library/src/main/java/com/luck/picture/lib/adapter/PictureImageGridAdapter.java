...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            ...
            String title = mimeType == PictureMimeType.ofImage() ?
                    context.getString(R.string.picture_take_picture)
                    : context.getString(R.string.picture_take_video);
            tv_title_camera.setText(title);

            int image = mimeType == PictureMimeType.ofImage() ?
                    R.drawable.ic_camera
                    : R.drawable.video_icon;
            Glide.with(context).asBitmap().load(image).into(camera);
        }
    }
